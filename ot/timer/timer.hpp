...
class Timer {
  ...
  public:
    ...
    void dump_tau2014_delay(std::ostream&) const;
    void dump_tau2014_timing(std::ostream&) const;
  ...
  private:
    ...
    void _dump_tau2014_delay(std::ostream&) const;
    void _dump_tau2014_timing(std::ostream&) const;
